...
namespace Aooshi.SnowFlake
{
    ...
    public class Generator
    {
        ...
        internal static int NumberOfGeneratorIdBits = 9;

        // should be 10 at least (4096 unique ids per millisecond per generator)
        internal static int NumberOfSequenceBits = 64 - NumberOfTimeBits - NumberOfGeneratorIdBits;
        ...
        /// set bits
        /// </summary>
        /// <param name="numberOfTimeBits"></param>
        /// <param name="numberOfGeneratorIdBits"></param>
        public static void SetBits(int numberOfTimeBits, int numberOfGeneratorIdBits)
        {
            Generator.NumberOfTimeBits = numberOfTimeBits;
            Generator.NumberOfGeneratorIdBits = numberOfGeneratorIdBits;
            //
            Generator.NumberOfSequenceBits = 64 - numberOfTimeBits - numberOfGeneratorIdBits;
        }
